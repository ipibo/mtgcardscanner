    ...
    <div className="flex flex-col gap-4">
      ...
      {card && (
        <>
          ...
          <div
            className="fixed bottom-0 left-0 right-0 z-[60] rounded-t-2xl bg-background border-t shadow-2xl max-w-lg mx-auto flex flex-col"
                      ...
                      return (
                        <li key={p.id}>
                          <button
                            ...
                            onClick={() =>
                              !isSelected && handleSelectPrinting(p)
                            }
                            disabled={isSelected}
                          >
                            <span
